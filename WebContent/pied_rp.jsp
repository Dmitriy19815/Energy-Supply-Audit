...
<%
    ...
    try {
		...
		z1_val = Math.abs((float)cc.getDataRangeByNameDouble(0,"q_qua_1"));
		z2_val = Math.abs((float)cc.getDataRangeByNameDouble(0,"q_qua_2"));
		z3_val = Math.abs((float)cc.getDataRangeByNameDouble(0,"q_qua_3"));
