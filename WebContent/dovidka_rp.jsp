...
<%	//обязательные параметры
	...
	double[] loss_float_r = new double[Points.size()];
	double[] loss_fixed_r = new double[Points.size()];
	for (int i=0; i < Points.size(); i++) {
		Point p = (Point)Points.get(i);
		str[i] = p.point_name;
		device_id[i] = p.device_id;
		loss_fixed_r[i] = 0; // p.loss_fixed_r;
		loss_float_r[i] = 0; // p.loss_float_r;
	}
%>

<div align="center"><b>2. Реактивна електроенергія (споживання)</b></div><br>
<div align="center"><b>2.1. Власне споживання реактивної електроенергії</b></div><br><br>
...
<tr align="center"> 
       ...
       <td class="datarow" colspan="4">Кількість електроенергії, квар&#x00B7;г</td>
       ...
       <td class="c"><%= device_id[i] %></td>
		...
		<% if (cc.getDataDov2ByName(i,"valid").equals("true")) { %>
			<% if (cc.getDataDov2ByNameDouble(i,"fval")>0) { %>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov2ByNameDouble(i,"q_qua_1")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov2ByNameDouble(i,"q_qua_2")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov2ByNameDouble(i,"q_qua_3")) %></td>
			<% } else { %>		
				<td class="c">0</td>
				<td class="c">0</td>
				<td class="c">0</td>
		...
		<% if (cc.getDataDov1ByName(i,"valid").equals("true")) { %>
			<% if (cc.getDataDov1ByNameDouble(i,"fval")>0) { %>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov1ByNameDouble(i,"q_qua_1")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov1ByNameDouble(i,"q_qua_2")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov1ByNameDouble(i,"q_qua_3")) %></td>
			<% } else { %>		
				<td class="c">0</td>
				<td class="c">0</td>
				<td class="c">0</td>
		...
		<% if (cc.getDataDovDiffByName(i,"valid").equals("true")) { %>
			<% if (cc.getDataDovDiffByNameDouble(i,"fval")>0) { %>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDovDiffByNameDouble(i,"q_qua_1")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDovDiffByNameDouble(i,"q_qua_2")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDovDiffByNameDouble(i,"q_qua_3")) %></td>
			<% } else { %>		
				<td class="c">0</td>
				<td class="c">0</td>
				<td class="c">0</td>
		...
		<% if (cc.getDataDovDiffByName(i,"valid").equals("true")) { %>
			...
			<% if (cc.getDataDovDiffByNameDouble(i,"fval")>0) { %>
				<td class="c"><% z1kvt = cc.getDataDovSaldoByNameDouble(i,"q_qua_1"); z1kvt_sum += z1kvt; %>
							<%= Basic.formatNumber(1,9,2,2,z1kvt) %></td>
				<td class="c"><% z2kvt = cc.getDataDovSaldoByNameDouble(i,"q_qua_2"); z2kvt_sum += z2kvt; %>
							<%= Basic.formatNumber(1,9,2,2,z2kvt) %></td>
				<td class="c"><% z3kvt = cc.getDataDovSaldoByNameDouble(i,"q_qua_3"); z3kvt_sum += z3kvt; %>
...
<%	z1 = 0; z2 = 0; z3 = 0; 
	...
	%>
<br><br>
<div align="center"><b>2.2. Транзит реактивної електроенергії (споживання)</b></div><br><br>
<table class="datahead" cellspacing="0" cellpadding="0" width="1534">
<tr align="center"> 
       <td class="datarow" rowspan="2" width="110">Об'єкт обліку</td>
       <td class="datarow" rowspan="2" width="120">Найменування<br> приєднання</td>
...
%>
<br><br>
<div align="center"><b>2.3. Сальдо реактивної електроенергії (споживання)</b></div><br><br>
<table class="datahead" cellspacing="0" cellpadding="0" width="1350">
  <tr align="center"> 
    ...
    <td colspan="4" class="datarow">Кількість електроенергії, квар&#x00B7;г</td>
  ...
  <tr align="center"> 
    ...
    <td rowspan="2" class="smalldatarow">%</td>
    <td colspan="3" class="smalldatarow">квар&#x00B7;г/місяць</td>
  </tr>
  <tr align="center"> 
    <td class="smalldatarow" width="80">Тариф 1<br>(нічний)</td>
    <td class="smalldatarow" width="80">Тариф 2<br>(напівпік.)</td>
...
<%	for (int i=0; i<Points.size(); i++) { %>
	...
	<tr align="right">
		...
		<td class="c">0,00</td>
		<td class="c"><%= Basic.formatNumber(1,4,2,2,loss_float_r[i]*100) %></td>

		<td class="c"><%= Basic.formatNumber(1,7,2,2,days*loss_fixed_r[i]*14/48) %></td>
		<td class="c"><%= Basic.formatNumber(1,7,2,2,days*loss_fixed_r[i]*22/48) %></td>
		<td class="c"><%= Basic.formatNumber(1,7,2,2,days*loss_fixed_r[i]*12/48) %></td>

		<td class="c"><% z_kvt_loss = days*loss_fixed_r[i]+z_kvt*loss_float_r[i]; z_kvt_sum_loss += z_kvt_loss; %>
