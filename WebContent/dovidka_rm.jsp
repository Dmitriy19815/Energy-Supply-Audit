...
<div align="center"><b>3. Реактивна електроенергія (генерація)</b></div><br>
<div align="center"><b>3.1. Власна генерація реактивної електроенергії</b></div><br><br>
       ...
       <td class="c"><%= device_id[i] %></td>
		...
		<% if (cc.getDataDov2ByName(i,"valid").equals("true")) { %>
			<% if (cc.getDataDov2ByNameDouble(i,"fval")>0) { %>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov2ByNameDouble(i,"q_gen_1")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov2ByNameDouble(i,"q_gen_2")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov2ByNameDouble(i,"q_gen_3")) %></td>
			<% } else { %>		
				<td class="c">0</td>
				<td class="c">0</td>
				<td class="c">0</td>
		...
		<% if (cc.getDataDov1ByName(i,"valid").equals("true")) { %>
			<% if (cc.getDataDov1ByNameDouble(i,"fval")>0) { %>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov1ByNameDouble(i,"q_gen_1")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov1ByNameDouble(i,"q_gen_2")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDov1ByNameDouble(i,"q_gen_3")) %></td>
			<% } else { %>		
				<td class="c">0</td>
				<td class="c">0</td>
				<td class="c">0</td>
		...
		<% if (cc.getDataDovDiffByName(i,"valid").equals("true")) { %>
			<% if (cc.getDataDovDiffByNameDouble(i,"fval")>0) { %>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDovDiffByNameDouble(i,"q_gen_1")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDovDiffByNameDouble(i,"q_gen_2")) %></td>
				<td class="c"><%= Basic.formatNumber(1,9,2,2,cc.getDataDovDiffByNameDouble(i,"q_gen_3")) %></td>
			<% } else { %>		
				<td class="c">0</td>
				<td class="c">0</td>
				<td class="c">0</td>
		...
		<% if (cc.getDataDovDiffByName(i,"valid").equals("true")) { %>
			...
			<% if (cc.getDataDovDiffByNameDouble(i,"fval")>0) { %>
				<td class="c"><% z1kvt = cc.getDataDovSaldoByNameDouble(i,"q_gen_1"); z1kvt_sum += z1kvt; %>
							<%= Basic.formatNumber(1,9,2,2,z1kvt) %></td>
				<td class="c"><% z2kvt = cc.getDataDovSaldoByNameDouble(i,"q_gen_2"); z2kvt_sum += z2kvt; %>
							<%= Basic.formatNumber(1,9,2,2,z2kvt) %></td>
				<td class="c"><% z3kvt = cc.getDataDovSaldoByNameDouble(i,"q_gen_3"); z3kvt_sum += z3kvt; %>
...
<%	z1 = 0; z2 = 0; z3 = 0; 
	...
	%>
<br><br>
<div align="center"><b>3.2. Транзит реактивної електроенергії (генерація)</b></div><br><br>
<table class="datahead" cellspacing="0" cellpadding="0" width="1534">
<tr align="center"> 
       <td class="datarow" rowspan="2" width="110">Об'єкт обліку</td>
       <td class="datarow" rowspan="2" width="120">Найменування<br> приєднання</td>
...
%>
<br><br>
<div align="center"><b>3.3. Сальдо реактивної електроенергії (генерація)</b></div><br><br>
